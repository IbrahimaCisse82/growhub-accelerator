  ...
  return (
    <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
      <SectionHeader title="Événements" subtitle="Calendrier des événements et activités du réseau"
        actions={<CreateEventDialog><GhButton>+ Créer événement</GhButton></CreateEventDialog>} />
          ...
          return (
            <div key={e.id} className="bg-surface-2 border border-border rounded-[10px] p-4 flex items-center gap-3.5 cursor-pointer hover:border-border/80 transition-colors">
              ...
              <div className="flex-1">
                ...
                <div className="text-[11.5px] text-muted-foreground mt-0.5">{e.location ?? (e.is_online ? "En ligne" : "—")}</div>
